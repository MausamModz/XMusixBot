...
from MausamMusic.core.call import Mausam, autoend, counter
from MausamMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Mausam.call_listeners(chat_id))
