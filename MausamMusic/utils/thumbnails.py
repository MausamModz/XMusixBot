...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("MausamMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("MausamMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("MausamMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("MausamMusic/assets/play_icons.png")
